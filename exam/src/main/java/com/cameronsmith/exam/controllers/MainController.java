...
public class MainController {
	...
	public String createIdea(@Valid @ModelAttribute("idea") Idea ideaInput, BindingResult result, HttpSession session,
			Model viewModel) {
		Long userId = (Long) session.getAttribute("user_id");
		User currentUser = this.uService.getById(userId);
		viewModel.addAttribute("currentUser", currentUser);
	...
	public String edit(@PathVariable("id") Long ideaId, @ModelAttribute("idea") Idea ideaInput, Model viewModel,
			HttpSession session) {
	...
	public String editIdea(@Valid @ModelAttribute("idea") Idea ideaInput, BindingResult result,
			@PathVariable("id") Long ideaId, Model viewModel, HttpSession session) {
		Idea ideaToEdit = this.iService.getById(ideaId);
		viewModel.addAttribute("thisIdea", ideaToEdit);
		if (result.hasErrors()) {
			viewModel.addAttribute("thisIdea", ideaToEdit);
